...
export const SKILLS: Record<SkillNames, Skill> = {
  ...
  [SkillNames.CPP]: {
    ...
    name: "cplusplus",
    label: "C++",
    shortDescription: "where performance matters and bugs fear undefined behavior ⚙️🔥",
    color: "#e34c26",
  ...
  [SkillNames.PYTHON]: {
    ...
    name: "python",
    label: "Python",
    shortDescription: "from quick scripts to serious ML—gets things done, fast 🐍🔥",
    color: "#563d7c",
...
using use = useUsing("use")`,
  ...
  [SkillNames.PYT]: {
    ...
    name: "pyt",
    label: "PyTorch",
    shortDescription: "teaching tensors to learn, backprop included 🔥",
    color: "#f7b93a",
  ...
  [SkillNames.TENSOR]: {
    ...
    name: "tensor",
    label: "TensorFlow",
    shortDescription: "building, training, and shipping models at scale 📦🤖",
    color: "#007acc",
  ...
  [SkillNames.NP]: {
    ...
    name: "np",
    label: "NumPy",
    shortDescription: "making math fast enough to feel illegal 🧮",
    color: "#e34c26",
