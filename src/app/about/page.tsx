...
const CONTACT_LINKS = [
  ...
  },
  {
    ...
    content: `@${config.social.instagram
      ...
      <div className="flex flex-col lg:flex-row gap-5">
        ...
        <main className="basis-3/4 w-[500px]">
          ...
          >
            ...
            <p className="mb-10">
              {config.intro} As a first-year student, I am continuously
              learning through projects in web development and cybersecurity,
              while building deeper understanding in hardware security
              research.
            </p>
